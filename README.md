...
// Device function for bubble sort
...
// Main function
int main() {
    int n = 100000; // Increase for larger datasets
...
<img width="1037" height="501" alt="image" src="https://github.com/user-attachments/assets/725961d6-ee22-4f8d-bd99-d3e13f92495f" />


## RESULT:
Thus, the program has been executed using CUDA to compare CPU and GPU implementations of Bubble Sort and Merge Sort. It is observed that CPU Bubble Sort took 0.000000 milliseconds, GPU Bubble Sort took 1.017856 milliseconds, CPU Merge Sort took 0.000000 milliseconds, and GPU Merge Sort took 41.494465 milliseconds. Hence, for this dataset, GPU Bubble Sort performed faster than CPU Bubble Sort, while CPU Merge Sort performed faster than GPU Merge Sort.
